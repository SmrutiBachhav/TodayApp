...
class ReminderViewController: UICollectionViewController {
    ...
    //When a reminder changes, the view controller should recognize and respond to the change.
...
//when you pass a closure as an argument, you need to label it as escaping if it’s called after the function returns.
    ...
    //The setEditing(_:animated:) method of UIViewController displays “Done” as the right navigation bar item when in editing mode and displays “Edit” when in view mode.
    ...
    @objc func didCancelEdit() {
        //If the user cancels their edits, you’ll reset the temporary working reminder to its original state.
